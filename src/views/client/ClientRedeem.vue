...
<template>
    <BaseLayout>
        ...
        <button @click="clickedYes" class="bg-green-800 rounded-lg w-1/2 p-5 text-white text-4xl text-center mt-4">Yes</button>
        <button @click="clickedNo" class="bg-red-800 rounded-lg w-1/2 p-5 text-white text-4xl text-center mt-4">No</button>
